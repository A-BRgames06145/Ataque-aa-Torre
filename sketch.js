...
var cannonExplosion, backgroundMusic, cannonWater, pirateLaugh;
...
function setup() {
  ...
  tower = new Tower(140,360,190,390);
  cannon = new Cannon(169, 90, 100, 50, angle);
...
function gameOver(){
  swal (
    {
      title: `Fim de Jogo!! Sua torre foi saqueada`,
